...
- [ ] 1. Set up project structure and Q-table data structure
...
- [ ] 2. Implement agent initialization with parameter validation
  - [ ] 2.1 Create RLAgent class with __init__ method
  ...
  - [ ] 2.2 Add parameter validation logic
...
- [ ] 3. Implement ε-greedy action selection
  - [ ] 3.1 Create select_action method
...
- [ ] 4. Implement Q-learning update logic
  - [ ] 4.1 Create update method
...
- [ ] 5. Implement manual environment for testing
  - [ ] 5.1 Create Environment class with execute method
  ...
  - [ ] 5.2 Add set_manual_mode method
...
- [ ] 6. Create simple test script to validate core loop
...
- [ ] 7. Checkpoint - Core learning loop functional
